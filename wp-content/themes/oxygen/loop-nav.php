...
?>
	...
	<?php elseif ( is_singular( 'post' ) ) : ?>
		...
		<div class="loop-nav">
			<?php previous_post_link( '<div class="previous">' . __( '&larr; %link', hybrid_get_parent_textdomain() ) . '</div>', '%title' ); ?>
			<?php next_post_link( '<div class="next">' . __( '%link', hybrid_get_parent_textdomain() ) . ' &rarr;</div>', '%title' ); ?>
		</div><!-- .loop-nav -->
